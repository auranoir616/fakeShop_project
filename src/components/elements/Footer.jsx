const Footer = () =>{
    return(
        <div className="h-80 w-full bg-slate-800 rounded-md mt-10 flex flex-col items-center justify-start text-white">
        <div className="flex flex-row justify-center items-center h-1/4 w-full">
    ...
    <div className="flex flex-row justify-center items-center h-1/2 w-3/4 ">
                <div className="w-1/4 flex flex-col justify-center items-center">
                    <p className="text-xl font-bold">ABOUT US</p>
                    <p className="text-center">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure corrupti debitis exercitationem sint
                    </p>
                </div>

                <div className="w-1/4 flex flex-col justify-center items-center">
                <p className="text-xl font-bold">News Letter</p>
                <p className="text-center">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure corrupti debitis exercitationem sint
                    </p>
